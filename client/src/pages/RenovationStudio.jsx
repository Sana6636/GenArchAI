...
export default function RenovationStudio({
    ...
    const handleRenovate = async () => {
        ...
        try {
            ...
            const data = await api.post('/renovate', formData, {
                headers: {
    ...
    return (
        <div className="page">
            ...
            <LoadingOverlay
                visible={loading}
                message="Renovating your room with AI..."
            />
            ...
            <div className="container">
                ...
                <div className="page-header">
                    ...
                    <p>
                        Upload a room photo and reimagine it in any architectural style
                    </p>
                </div>
                        ...
                        <div className="card comparison-card">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span className="comp-label comp-label-left">
                                        Original
                                    </span>
                                </div>
                                ...
                                <div className="comp-renovated">
                                    ...
                                    <span className="comp-label comp-label-right">
                                        {style}
                                    </span>
                            ...
                            <div className="card panel-card">
                                ...
                                {renovatedUrl ? (
                                    ...
                                    <div className="panel-placeholder">
                                        ...
                                        <span>
                                            Renovated room will appear here
                                        </span>
